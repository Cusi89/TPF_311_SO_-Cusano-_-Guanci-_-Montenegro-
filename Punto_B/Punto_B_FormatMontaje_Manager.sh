...
/dev/sdc1  ${HOME_USER}/Manager/Servicios       ext4  defaults  0  2
/dev/sdc2  ${HOME_USER}/Manager/Monitoreo       ext4  defaults  0  2
/dev/sdc5  ${HOME_USER}/Manager/Servicios/Web   ext4  defaults  0  2
/dev/sdc6  ${HOME_USER}/Manager/Servicios/Cache ext4  defaults  0  2
/dev/sdc7  ${HOME_USER}/Manager/Monitoreo/Logs  ext4  defaults  0  2
EOF"
